...
//            ------------ Front End
            ...
            $data['config_webname'] = $data_info['config_webname'];
            ...
            $data['config_content'] = $data_info['config_content'];
            $data['contact_image'] = $data_info['contact_image'];
...
//        echo var_dump($this->input->post());
    ...
    public function validate_frontend_form()
    {
        ...
        if ((strlen($this->input->post('config_webname')) < 3) || (strlen($this->input->post('config_webname')) > 255)) {
            $this->error['config_webname'] = "กรุณากรอกข้อมูล title";
        }
    ...
    public function validate_contact_form()
    {
        ...
        if ((strlen($this->input->post('telephone')) < 3) || (strlen($this->input->post('telephone')) > 255)) {
            $this->error['telephone'] = "กรุณากรอกข้อมูล Telephone";
        }
