...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">Link Stream</li>
    </ol>
</section>
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    <div class="box-header with-border">
                        <h3 class="box-title">ข้อมูลการสร้าง Link Stream</h3>
                    </div>
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form"
                        ...
                        <input type="hidden" name="link_id" value="<?php echo $link_id; ?>"
                               id="link_id" class="form-control"/>

                        <div class="row">

                            <div class="form-group required col-md-12 col-xs-12">
                                <div class="col-md-2 col-xs-2" align="right">
                                    <label class=" control-label" for="input-type-name">Channel Name</label>
                                </div>
                                <div class="col-md-10 col-xs-10">
                                    <div class="">
                                        <input type="text" name="channel_name" value="<?php echo $link_channel; ?>"
                                               placeholder="Channel Name" id="input-channel-name"
                                               class="form-control"/>
                                    </div>
                            ...
                            <div class="form-group required col-md-12 col-xs-12">
                                <div class="col-md-2 col-xs-2" align="right">
                                    <label class=" control-label" for="input-priority-level">Live Stream Link</label>
                                </div>
                                <div class="col-md-10 col-xs-10">
                                    <div class="">
                                        <input type="text" name="youtube_link" value="<?php echo $youtube_link; ?>"
                                               placeholder="Stream Link" id="input-stream-link"
                                               class="form-control"/>
                                    </div>
                                    <div class="text-danger"></div>
                                </div>
                                ...
                                <div class="col-md-10 col-xs-10">
                                    <div class="">
                                        <select name="type_status" id="input-status" class="form-control">
                                            <option
                                                value="0" <?php if ($link_status == 0) { ?>
                                                selected="selected" <?php } ?> >
                                                ปิดการใช้งาน
                                            </option>
                                            <option
                                                value="1" <?php if ($link_status == 1) { ?>
                                                selected="selected" <?php } ?>>
                                                เปิดใช้งาน
                                            </option>
